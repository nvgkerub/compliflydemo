...
class LibraryScreen extends Component {
  ...
  _splitData(d) {
    for (var i = 0; i <= d.length; i++) {
      ...
      if (
        f.includes(strings.libraryFileTypes.document.pdf.toUpperCase()) ||
        f.includes(strings.libraryFileTypes.document.txt.toUpperCase()) ||
        f.includes(strings.libraryFileTypes.document.doc.toUpperCase()) ||
        f.includes(strings.libraryFileTypes.document.docx.toUpperCase()) ||
        f.includes(strings.libraryFileTypes.document.rtf.toUpperCase())
      ) {
