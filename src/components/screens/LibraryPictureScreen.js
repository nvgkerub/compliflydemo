...
const filler = [
  { title: 'picture.png', subTitle: '683 MB, modified yesterday 4:25 PM' },
  { title: 'picture.jpg', subTitle: '683 MB, modified yesterday 4:25 PM' },
];
...
class LibraryPictureScreen extends Component {
  ...
  _renderItems = () => {
    ...
    return filler.map((item, i) => {
      return (
        <PictureItem key={i} title={item.title} subTitle={item.subTitle} />
      );
    });
  }
...
export default connect(null, null)(LibraryPictureScreen);
