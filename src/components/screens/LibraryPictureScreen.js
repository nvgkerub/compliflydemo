...
class LibraryPictureScreen extends Component {
  ...
  _splitData(d) {
    for (var i = 0; i <= d.length; i++) {
      ...
      if (
        f.includes(strings.libraryFileTypes.picture.jpg.toUpperCase()) ||
        f.includes(strings.libraryFileTypes.picture.jpeg.toUpperCase()) ||
        f.includes(strings.libraryFileTypes.picture.png.toUpperCase())
      ) {
...
export default connect(mapStateToProps, null)(LibraryPictureScreen);
